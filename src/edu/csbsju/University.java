...
public class University {
	...
	public University(String universityName, String state, String location, String control, int numberOfStudents,
		...
		setNumberOfApplicants(numberOfApplicants);
		//this.percentAdmitted = percentAdmitted;
		setPercentAdmitted(percentAdmitted);
		//this.percentEnrolled = percentEnrolled;
		setPercentEnrolled(percentEnrolled);
		//this.academicScale = academicScale;
		setAcademicScale(academicScale);
		//this.socialScale = socialScale;
		setSocialScale(socialScale);
		//this.qualityOfLife = qualityOfLife;
		setQualityOfLife(qualityOfLife);
